...
// EscapeAt escapes literal @ in attribute values for PromQL (ZIP-0006: @@ escaping).
func EscapeAt(value string) string {
...
// UnescapeAt converts @@ back to literal @ in attribute names.
func UnescapeAt(value string) string {
